...
import { amoundOptions, formSchema, resolutionOptions } from "./constants";
...
const ImagePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      setImages([]); //we want to reset all the images every time we submit
